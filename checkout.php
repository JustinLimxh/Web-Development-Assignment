...
if(isset($_POST['order_btn'])){
   ...
   if($cart_total == 0){
      ...
      if(mysqli_num_rows($order_query) > 0){
         ...
         mysqli_query($conn, "INSERT INTO `orders`(user_id, name, number, email, method, total_products, total_price) VALUES('$user_id', '$name', '$number', '$email', '$method', '$total_products', '$cart_total')") or die('query failed');
...
<section class="display-order">
   ...
   ?>
   <p> <?php echo $fetch_cart['name']; ?> <span>(<?php echo 'RM'.$fetch_cart['price']; ?>)</span> </p>
   <?php
      }
   }else{
